...
class Salicon(nn.Module):
    def __init__(self):
        ...
        self.Vgg16_fine_features=models.vgg16(pretrained=True).features[0:30] #type: ignore
        self.Vgg16_coarse_features=models.vgg16(pretrained=True).features[0:30] #type: ignore
